...
<template>
    <div class="fixed top-0 left-0 w-full z-50 bg-surface-0 dark:bg-surface-900 shadow-md py-6 px-6 lg:px-20 flex items-center justify-between">
        <a class="flex items-center" @click="goHome">
            ...
            <span class="text-surface-900 dark:text-surface-0 font-medium text-2xl leading-normal mr-20">FYP</span>
        </a>
        <Button
            class="lg:!hidden"
            text
        ...
        <div class="items-center bg-white dark:bg-surface-900 grow justify-between hidden lg:flex absolute lg:static w-full left-0 top-full px-12 lg:px-0 z-20 rounded-border shadow-lg lg:shadow-none">
            ...
            <div class="flex border-t lg:border-t-0 border-surface py-4 lg:py-0 mt-4 lg:mt-0 gap-2">
                ...
                <Button v-if="!hasToken" label="Register" as="router-link" to="/auth/register" rounded />
